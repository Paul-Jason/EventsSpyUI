...
DELETE FROM "ACME"."USER_CREATED_EVENTS" AS "USER_EVENTS" WHERE "USER_EVENTS"."EVENT_ID"=1

DELETE FROM "ACME"."CREATED_EVENTS" AS "USER_EVENTS" WHERE "USER_EVENTS"."EVENT_ID"=1
DELETE FROM "ACME"."USER_REGISTERED_EVENTS_WITH_STATUS" AS "USER_EVENTS" WHERE "USER_EVENTS"."USER_ID"=1
